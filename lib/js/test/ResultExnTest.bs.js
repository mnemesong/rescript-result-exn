...
Mocha$RescriptMocha.describe("test ResultExn")(undefined, undefined, undefined, (function (param) {
        ...
        Mocha$RescriptMocha.describe("test catchExn")(undefined, undefined, undefined, (function (param) {
                Mocha$RescriptMocha.it("positive")(undefined, undefined, undefined, (function (param) {
                        var f = function (param) {
                          return 12;
                        };
                        var result = ResultExn.catchExn(f);
                        Assert$RescriptMocha.deep_equal(undefined, result, {
                              TAG: /* Ok */0,
                              _0: 12
                            });
                ...
                Mocha$RescriptMocha.it("negative")(undefined, undefined, undefined, (function (param) {
                        ...
                        var result = ResultExn.catchExn(f);
                        Assert$RescriptMocha.ok(ResultExn.isError(result));
                      }));
              }));
        Mocha$RescriptMocha.describe("test catchResult")(undefined, undefined, undefined, (function (param) {
                Mocha$RescriptMocha.it("positive")(undefined, undefined, undefined, (function (param) {
                        var f = function (param) {
                          return {
                                  TAG: /* Ok */0,
                        ...
                        var result = ResultExn.catchResult(f);
                        Assert$RescriptMocha.deep_equal(undefined, result, {
                              TAG: /* Ok */0,
                              _0: 12
                            });
                ...
                Mocha$RescriptMocha.it("negative 1")(undefined, undefined, undefined, (function (param) {
                        ...
                        var result = ResultExn.catchResult(f);
                        Assert$RescriptMocha.deep_equal(undefined, ResultExn.getErr(result), {
                              RE_EXN_ID: TestExn
                            });
                      }));
              }));
